...
jsPsych.plugins["RDK"] = (function() {
	...
	plugin.info = {
	    ...
	    parameters: {
		    ...
		    text_above: {																	//Martin
		      ...
		      default: "",																	//Martin
		      description: "Text to place above aperture(s)"								//Martin
		    },
		    text_below_one: {																//Martin
		      type: jsPsych.plugins.parameterType.STRING,									//Martin
		      pretty_name: "Text below (1)",												//Martin
		      default: "",																	//Martin
		      description: "Text to place below first aperture"								//Martin
		    },
		    text_below_two: {																//Martin
		      type: jsPsych.plugins.parameterType.STRING,									//Martin
		      pretty_name: "Text below (2)",												//Martin
		      default: "",																	//Martin
		      description: "Text to place below second aperture"							//Martin
		    },
		    text_center: {																	//Marlene
		      type: jsPsych.plugins.parameterType.STRING,									//Marlene
		      pretty_name: "Text center",													//Marlene
		      default: "",																	//Marlene
		      description: "Text to place in center of screen)"								//Marlene
		    },													
	    }
	}//
	...
	plugin.trial = function(display_element, trial) {
		...
		trial.text_above = assignParameterValue(trial.text_above, "");						//Martin
		trial.text_below_one = assignParameterValue(trial.text_below_one, "");				//Martin
		trial.text_below_two = assignParameterValue(trial.text_below_two, "");				//Martin
		trial.text_center = assignParameterValue(trial.text_center, "");	  				//Marlene
		...
		*/
		...
		function end_trial() {
			...
			var trial_data = { 
				...
				"coherent_direction": JSON.stringify(trial.coherent_direction), //Marlene
				...
				//Marlene
				"block_congruent": trial.block_congruent
		...
		function draw() {
		    ...
		    if(fixationCross === true){
      		...
      		//Draw text if called for																		//Martin     		
      		ctx.fillStyle="black"																	//Marlene
      		ctx.font = "36px Arial";																		//Martin
      		ctx.textAlign = "center";
      		ctx.fillText(trial.text_above,window.innerWidth/2,window.innerHeight/14); 	
      		ctx.font = "50px Arial";																//Marlene
      		ctx.fillText(trial.text_center, window.innerWidth/2, 21*window.innerHeight/40);	        		//Martin
      		ctx.font = "25px Arial"; 	        															//Martin
      		ctx.fillText(trial.text_below_one,window.innerWidth/4,window.innerHeight*13/14); 	        //Martin
			ctx.fillText(trial.text_below_two,window.innerWidth*3/4,window.innerHeight*13/14); 	   
	        
		}//End of draw

		//Update the dots with their new location
		function updateDots() {
			ctx.fillStyle = dotColor;																	//Marlene
